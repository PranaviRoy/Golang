...
var file_greeter_proto_rawDesc = []byte{
	...
	,
...
var file_greeter_proto_depIdxs = []int32{
	0, // 0: proto.GreetingService.Reply:input_type -> proto.Request
	1, // 1: proto.GreetingService.Reply:output_type -> proto.Response
...
type GreetingServiceClient interface {
	Reply(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *greetingServiceClient) Reply(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/proto.GreetingService/Reply", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreetingServiceServer interface {
	Reply(context.Context, *Request) (*Response, error)
}
...
func (*UnimplementedGreetingServiceServer) Reply(context.Context, *Request) (*Response, error) {
...
func _GreetingService_Reply_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreetingServiceServer).Reply(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.GreetingService/Reply",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetingServiceServer).Reply(ctx, req.(*Request))
	}
...
var _GreetingService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Reply",
			Handler:    _GreetingService_Reply_Handler,
		},
	},
